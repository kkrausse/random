/**
 * Supported xterm-style interfaces for the local Ghostty browser wrapper.
 * These describe a subset, not a promise of full xterm.js compatibility.
 */
...
export interface ITerminalOptions {
   ...
   * quads); 'canvas' is the default Canvas2D one. Unsupported WebGL2 falls
   * back to canvas.
   */
