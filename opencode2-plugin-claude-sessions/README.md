...
- Tap/click a row to preview, then **Open** to enter it; **New** and **Close** are also clickable. Approval previews have **Once**, **Always**, and **Deny** buttons alongside the existing keyboard shortcuts.
