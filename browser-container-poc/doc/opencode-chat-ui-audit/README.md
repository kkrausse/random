...
- This is the revision matched by the existing browser guest's core/schema **`0.0.0-dev-19167`**. Local receipts: [`vivari-v2-results.md`](../vivari-v2-results.md), [`workspace-demo/prepare.ts`](../../workspace-demo/prepare.ts), and [`TESTING-HANDOFF.md`](../../workspace-demo/TESTING-HANDOFF.md). This audit did not rebuild or independently rematch the guest binary.
