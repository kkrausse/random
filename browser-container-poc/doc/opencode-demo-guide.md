...
```sh
cd /Users/kkrausse/Documents/repos/kkrausse/random/browser-container-poc/opencode-demo
bun serve.ts
```
...
- `../opencode-demo/evidence/final.png`: current provider dialog.
- `../opencode-demo/evidence/provider-search.png`: typed `nemotron`, no results.
- `../opencode-demo/evidence/final.json`: phases/server logs/hash inventory and gates.
...
```sh
browser-control execute --session rapid-raven-074 --file browser-container-poc/opencode-demo/accept.js
```
