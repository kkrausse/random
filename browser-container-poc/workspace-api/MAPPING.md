...
Durable backend changes live in `../vivari/patches/0001-sqlite.patch`, applied to
upstream `2629c71097238400c45aefa213ef61df4794c2b7` by the established build script.
The ignored `.runtime/patched` checkout is a working build tree, not independent
source of truth. No workers in emitted distributions were hand-edited.
