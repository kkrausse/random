...
import { WorkspaceProvider, useWorkspace, type ControllerDiagnosticEvent } from '@vivari/workspace-api/react';
...
export { Workspace, Runtime, opfsStore, attachPreview, distribution };
`);
...
import { WorkspaceProvider, WorkspaceController } from '@vivari/workspace-api/react';
