# kev-browser-agent-kit · Chat client demo

Earlier standalone DOM chat fixture for OpenCode 2. For the current reusable
package, use [`@kev-browser-agent-kit/opencode-chat`](../opencode-chat/README.md);
the [editable app demo](../editable-app-demo/README.md) shows its React integration.
...
```ts
import { mountOpenCodeClient } from "../chat-client-demo/src/client";
