...
export async function checkAssets(verify = false) {
  const fix = "From browser-container-poc/workspace-demo run: bun run demo. It prepares missing/stale apps. See README prerequisites if the pinned runtime or OpenCode source is unavailable.";
  try {
