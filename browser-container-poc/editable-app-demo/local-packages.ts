...
export async function checkLocalPackages() {
  for (const specifier of ["@kev-browser-agent-kit/workspace", "@kev-browser-agent-kit/workspace/react", "@kev-browser-agent-kit/workspace/server", "@kev-browser-agent-kit/opencode-chat", "@kev-browser-agent-kit/opencode-chat/react", "@kev-browser-agent-kit/opencode-chat/styles.css"]) {
    try {
