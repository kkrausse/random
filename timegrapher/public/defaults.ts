...
export const DEFAULT_PRECEDING_EVENT_SMOOTHING_RADIUS_SECONDS = 0.00035;
// TODO figure out how this is used? is it % across full cycle or just within the window?
export const DEFAULT_PRECEDING_EVENT_THRESHOLD_PERCENTILE = 80;
export const MIN_PERIOD_SECONDS = 1;
export const MAX_PERIOD_SECONDS = 20;
...
export const BASE_BANDS = [
  ...
  { name: "10000-12000", low: 10000, high: 12000 },
  { name: "12000-14000", low: 12000, high: 14000 },
