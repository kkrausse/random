...
- `/search` - **Search.** Global sighting search.
...
flowchart TD
    ...
    Search -->|"click sighting"| SightingDetail
    Search -->|"edit own sighting"| SightingEdit
...
- `GET /api/search` - global search with optional `userId` scope.
